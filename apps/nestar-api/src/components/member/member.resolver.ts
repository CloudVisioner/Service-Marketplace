...
export class MemberResolver {
	...
	public async checkAuthRoles(@AuthMember() authMember: Member): Promise<string> {
		...
		return await `Hi ${authMember.memberNick}, you are ${authMember.memberType} (memeberId: ${authMember._id}) `;
	}

	@UseGuards(AuthGuard)
	@Mutation(() => Member)
	public async updateMember(
		@Args('input') input: MemberUpdate, // id is not allowed to update
	...
	@Query(() => Member)
	public async getMember(@Args('memberId') input: string, @AuthMember('_id') memberId: ObjectId): Promise<Member> { // memberId comes as a string
